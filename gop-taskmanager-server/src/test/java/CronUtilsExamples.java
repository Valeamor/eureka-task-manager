...
public class CronUtilsExamples {
  ...
  public static void main(String[] args) {
    ...
    System.out.println(
        String
            .format("If the following expression fails to validate, we get an exception! Validated expression is: '%s'",
    ...
    System.out.println(
        String.format("Quartz expression '%s' is described as '%s'", quartzBuiltCronExpression.asString(),
                      quartzBuiltCronExpressionDescription)
                      );
